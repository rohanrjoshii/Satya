...
const FlipTextReveal = () => {
  ...
  useEffect(() => {
    ...
    if (!first || !second || !box || !text) return;
    ...
    void import("gsap/dist/Flip.js").then((flipModule) => {
      ...
      flipTimer = window.setTimeout(() => {
        ...
        flipPlugin.from(state, { duration: 1, ease: "power4.inOut" });
  ...
  return (
    <div className="flex h-full w-full items-center justify-center gap-20">
      ...
      <div className="flex flex-col gap-6 text-3xl">
        ...
        />
        <span ref={textRef} className="w-96 flex flex-wrap gap-x-2">
